...
class SagePay {
	...
	protected $language;
	protected $website;
	// protected $encryptPassword = "a0c7b95328d511af"; // live
	protected $encryptPassword = "9ddd357a1a0dca89"; // test
	...
	protected function createVendorTxCode() {
	 ...
	 return "a$timestamp.$random_number";
	}
	...
	protected function encryptAndEncode($strIn) {
		...
		if (in_array($cipher, openssl_get_cipher_methods()))
		{
					 ...
					 $encrypted = openssl_encrypt($strIn,$cipher,$this->encryptPassword, OPENSSL_RAW_DATA,$this->encryptPassword);
	...
	protected function decodeAndDecrypt($strIn) {
		                 ...
		                 $cipher = "aes-128-cbc";
				//return "tst".$crypt = openssl_decrypt($strIn,$cipher,$this->encryptPassword, OPENSSL_RAW_DATA,$this->encryptPassword);
				
						 $strIn = hex2bin(substr($strIn, 1));
						 return $strIn = openssl_decrypt($strIn,'aes-128-cbc',$this->encryptPassword, OPENSSL_RAW_DATA,$this->encryptPassword);
