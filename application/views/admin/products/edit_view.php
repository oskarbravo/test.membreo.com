        ...
        <div class="tabs-container">
          ...
          <div class="tab-content">
                  ...
                  <form method="post" action="<?= site_url('admin/products/save_product_info'); ?>">
                      ...
                      <fieldset>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Name:</label>
                            <div class="col-sm-10"><input value="<?= $product->name; ?>" type="text" class="form-control" placeholder="Product name" name="name"></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Price:</label>
                            <div class="col-sm-10"><input value="<?= $product->price; ?>" type="text" class="form-control" placeholder="$160.00" name="price"></div>
                        </div>
                        ...
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Meta Tag Title:</label>
                            <div class="col-sm-10"><input value="<?= $product->meta_tag_title; ?>" type="text" class="form-control" placeholder="..." name="meta_tag_title"></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Meta Tag Description:</label>
                            <div class="col-sm-10"><input value="<?= $product->meta_tag_description; ?>" type="text" class="form-control" placeholder="..." name="meta_tag_description"></div>
                        </div>
                        <div class="form-group row"><label class="col-sm-2 col-form-label">Meta Tag Keywords:</label>
                            <div class="col-sm-10"><input value="<?= $product->meta_tag_keywords; ?>" type="text" class="form-control" placeholder="..." name="meta_tag_keywords"></div>
                        </div>
                      </fieldset>
            ...
            <div id="tab-2" class="tab-pane">
                <div class="panel-body">
                    <form method="post" action="<?= site_url('admin/products/save_data'); ?>">
                        <input type="hidden" name="id" value="<?= $product->id; ?>">
                        <fieldset>
