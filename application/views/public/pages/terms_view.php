        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-10">
            ...
            <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: true, &quot;dots&quot;: true, &quot;loop&quot;: true }">
              <figure><img src="<?php echo base_url(); ?>img/public/blog/single/01.jpg" alt="Image">
                <figcaption class="text-white">Image Caption</figcaption>
              </figure>
              <figure><img src="<?php echo base_url(); ?>img/public/blog/single/02.jpg" alt="Image">
                <figcaption class="text-white">Image Caption</figcaption>
              </figure>
              <figure><img src="<?php echo base_url(); ?>img/public/blog/single/03.jpg" alt="Image">
                <figcaption class="text-white">Image Caption</figcaption>
              </figure>
            </div>
